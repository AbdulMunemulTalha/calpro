      ...
      <div className="container-sm" style={{ padding: '3rem 1.5rem' }}>
        ...
        <div style={{ lineHeight: 1.8, color: 'var(--text-2)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: '1.5rem' }}>
            {['No account required to use any calculator', 'No inputs or results are sent to our servers', 'No personal data is collected or sold', 'No cookies beyond essential site functionality'].map((item, i) => (
...
export function PrivacyPage() {
  return (
    <>
      <Helmet>
        <title>Privacy Policy — CalPro</title>
        <meta name="description" content="CalPro privacy policy. We don't collect personal data, sell information, or require sign-up. All calculations run in your browser." />
      ...
      <div className="container-sm" style={{ padding: '3rem 1.5rem' }}>
        ...
        <div style={{ lineHeight: 1.85, color: 'var(--text-2)', fontSize: '0.97rem' }}>
          {[
            { h: 'Overview', body: 'CalPro (calpro.store) is committed to protecting your privacy. All calculations performed on CalPro run entirely in your browser. No calculation inputs or results are transmitted to our servers.' },
            { h: 'Information We Do Not Collect', body: 'We do not collect, store, or process: calculation inputs or results you enter into our calculators; personal identification information such as name, email, or address (unless you contact us); financial data, health data, or any sensitive personal information.' },
            { h: 'Information We May Collect', body: 'We may collect anonymous analytics data such as page views, general geographic region, browser type, and device type through Google Analytics. This data cannot be used to identify you personally. We also collect standard server logs (IP addresses, request timestamps) for security purposes, which are deleted after 30 days.' },
            { h: 'Advertising', body: 'CalPro uses Google AdSense to display advertisements. Google may use cookies to serve ads based on your prior visits to this or other websites. You can opt out of personalized advertising by visiting Google\'s Ad Settings page or by using the AdChoices link in displayed ads.' },
            { h: 'Cookies', body: 'CalPro uses minimal cookies: a theme preference cookie (dark/light mode) stored locally in your browser, and standard Google Analytics cookies for anonymous usage statistics. No tracking cookies are used for advertising targeting on our part.' },
            { h: 'Third-Party Links', body: 'Our calculators may display affiliate links to third-party services. We are not responsible for the privacy practices of these third parties. Please review their privacy policies before using their services.' },
            { h: 'Data Security', body: 'Since we do not collect or store personal data, there is minimal risk of a data breach affecting your personal information. Our website uses HTTPS encryption for all connections.' },
            { h: 'Children\'s Privacy', body: 'CalPro is not directed at children under 13 years of age. We do not knowingly collect information from children.' },
            { h: 'Changes to This Policy', body: 'We may update this privacy policy from time to time. The updated date at the top of this page will reflect any changes. Continued use of CalPro after changes constitutes acceptance of the updated policy.' },
            { h: 'Contact', body: 'If you have questions about this privacy policy, please contact us through our contact page.' },
          ].map((s, i) => (
      ...
      <div className="container-sm" style={{ padding: '3rem 1.5rem' }}>
        ...
        <div style={{ lineHeight: 1.85, color: 'var(--text-2)', fontSize: '0.97rem' }}>
          {[
            ...
            { h: 'Advertising & Affiliates', body: 'CalPro displays Google AdSense advertisements and may include affiliate links to third-party products and services. We may earn a commission on qualifying purchases made through affiliate links. This does not affect our editorial decisions or the accuracy of our calculators.' },
